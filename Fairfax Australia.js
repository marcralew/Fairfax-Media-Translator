{
	...
	"translatorType": 4,
	"browserSupport": "gcsi",
	"lastUpdated": "2016-10-07 01:10:10"
}
...
date		: FW.Xpath('//*[@id="content"]/main/article/header/div[1]/ul/li[1]/time').text().trim(),
creators	: FW.Xpath('//h5[@itemprop="name"]').text().split(/, |" and "/).cleanAuthor("Author"),
ISSN        : "0312-6307",
...
var testCases = [
	...
	{
		"type": "web",
		"url": "http://www.theage.com.au/comment/how-on-earth-did-sharks-become-the-new-dolphin-20161006-grwojo.html",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "How on earth did sharks become the new dolphin?",
				"creators": [
					{
						"firstName": "Garry",
						"lastName": "Linnell",
